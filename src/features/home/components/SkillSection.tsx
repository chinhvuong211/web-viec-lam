...
function SkillSection() {
    return (
        <section className="bg-theme-background">
            <div className="max-w-screen-xxl left-0 right-0 mx-auto p-24 max-lg:px-5 max-lg:py-10">
                                ...
                                >
                                    ...
                                    <div className="max-lg:mt-8">
                                        <Image
                                            ...
                                            height={169}
                                            alt={item.name}
                                            className="aspect-[18.75rem/10.5625rem] object-cover max-lg:w-full w-[18.75rem]"
                                        />
                                    </div>
                                </div>
                            );
